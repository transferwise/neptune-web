...
By default `NavigationOption` is meant to be used with Icons.

<div className="p-b-2">
  <NavigationOption
    id="navigation-option"
    name="navigation-option"
    title="Default navigation option"
...
If you want to use full colour & spot illustrations instead then set `showMediaCircle` to `false`.

<div className="p-b-2">
  <NavigationOption
    id="navigation-option"
    name="navigation-option"
    title="Navigation option with colour illustration"
    content="Button and illustration are vertically centered."
    onClick={() => alert('clicked')}
...
By default icons & illustrations are hidden on small/mobile screens. If you want them to be visible then set `showMediaAtAllSizes` to `true`.
...
<div className="p-b-2">
  <NavigationOption
    ...
    content="Icon / illustration will be shown on mobiles as well."
    onClick={() => alert('clicked')}
    media={<ExampleIllustration />}
...
export const ExampleIllustration = () => (
