...
Use the inverse nabvar over background imagery and using helper classes like `.navbar-background--inverse`.

<nav className="navbar navbar-inverse navbar-background--inverse">
  <div className="container-fluid">
    <div className="navbar-header">
...
<header className="navbar navbar-inverse subnav navbar-background--inverse">
  <div className="container">
    <div className="navbar-header">
...
<Code lang="html">{`<nav class="navbar subnav navbar-inverse navbar-background--inverse">
  ...
  <ul class="nav navbar-nav subnav-menu">
    <li class="active"><a class="navbar-title-link" href="/">Title</a></li>
    <li class="dropdown">...</li>
