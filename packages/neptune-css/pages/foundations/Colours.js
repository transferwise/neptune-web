...
export default () => (
  <>
    ...
    <h3>Brand colours</h3>
    <p>We use primary brand colours for elements that must reflect our brand. Each colour has a complementary dark colour. Whenever possible, use the lighter shades. They enhance the visual energy of our brand, and aid recognition. We use the darker colours within our UI to represent different states.</p>

    <div className="alert">All the custom-properties have their equivalent <code>@variable</code> of Less</div>
    ...
    <h3 className="m-t-4">UI colours</h3>
    <p>We use the main UI colours for action buttons, alert messages, form elements, and input fields.</p>
