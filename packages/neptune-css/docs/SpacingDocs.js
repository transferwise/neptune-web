      ...
      <section id="spacing" className="wrap--content">
        <div className="bs-docs-section">
          <h1 className="colored-dot">
            Spacing <span className="badge badge-info">BT</span>
          </h1>
          <p className="lead">
            <span className="badge">WIP</span> Testing a existing component of
            TW Bootstrap
          </p>
          ...
          <ul>
            <li>
              <code>a</code> - for classes that set a <code>margin</code> or{" "}
              <code>padding</code> on all 4 sides of the element
            </li>
            <li>
              <code>t</code> - for classes that set the <code>top</code> side of
              the property
            </li>
            <li>
              <code>b</code> - for classes that set the <code>bottom</code> side
              of the property
            </li>
            <li>
              <code>l</code> - for classes that set the <code>left</code> side
              of the property
            </li>
            <li>
              <code>r</code> - for classes that set the <code>right</code> side
              of the property
            </li>
            <li>
          ...
          <p>
            Our base unit for the spacer is: <code>@spacer: 8px;</code>
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              <code>padding</code> to <code>@spacer * 1</code> (8px)
            </li>
            <li>
              <code>2</code> - for classes that set the <code>margin</code> or{" "}
              <code>padding</code> to <code>@spacer * 2</code> (16px)
            </li>
            <li>
              <code>3</code> - for classes that set the <code>margin</code> or{" "}
              <code>padding</code> to <code>@spacer * 3</code> (24px)
            </li>
            <li>
          ...
          <ul>
            <li>
              <code>4</code> - for classes that set the{" "}
              <code>margin-top, margin-bottom</code> or{" "}
              <code>padding-top, padding-bottom</code> to{" "}
              <code>@spacer * 4</code> (32px)
            </li>
            <li>
              <code>5</code> - for classes that set the{" "}
              <code>margin-top, margin-bottom</code> or{" "}
              <code>padding-top, padding-bottom</code> to{" "}
              <code>@spacer * 5</code> (40px)
            </li>
          </ul>
          ...
          <ul>
            <li>
              <code>section-1</code> classes provide{" "}
              <strong>16px, 24px or 32px</strong>
              of spacing depending on screen width.
            </li>
            <li>
              <code>section-2</code> classes provide{" "}
              <strong>24px, 48px or 64px</strong>
              of spacing depending on screen width.
            </li>
            <li>
              <code>section-3</code> classes provide{" "}
              <strong>48px, 72px or 96px</strong>
              of spacing depending on screen width.
            </li>
            <li>
              <code>section-5</code> classes provide{" "}
              <strong>80px, 120px or 160px</strong>
              of spacing depending on screen width.
            </li>
            <li>
              <code>section-7</code> classes provide{" "}
              <strong>112px, 168px or 224px</strong>
              of spacing depending on screen width.
            </li>
          </ul>
          <p className="alert alert-info">
            Keep in mind that we jump <strong>4</strong> and <strong>6</strong>{" "}
          ...
          <figure className="highlight">
            <pre>
              <code className="language-html" data-lang="html">
                ...
                <span className="nt">&gt;</span>m-t-section-1
                <span className="nt">&lt;/h6&gt;</span>
                <span className="nt">&lt;h6</span>{" "}
                <span className="na">className=</span>
                ...
                <span className="nt">&gt;</span>p-t-section-1
                <span className="nt">&lt;/h6&gt;</span>
                <span className="nt">&lt;h6</span>{" "}
                <span className="na">className=</span>
          ...
          <figure className="highlight">
            <pre>
              <code className="language-html" data-lang="html">
                ...
                <span className="nt">&gt;</span>m-b-section-1
                <span className="nt">&lt;/h6&gt;</span>
                <span className="nt">&lt;h6</span>{" "}
                <span className="na">className=</span>
                ...
                <span className="nt">&gt;</span>p-b-section-1
                <span className="nt">&lt;/h6&gt;</span>
                <span className="nt">&lt;h6</span>{" "}
                <span className="na">className=</span>
          ...
          <figure className="highlight">
            <pre>
              <code className="language-html" data-lang="html">
                ...
                <span className="nt">&gt;</span>m-y-section-1
                <span className="nt">&lt;/h6&gt;</span>
                <span className="nt">&lt;h6</span>{" "}
                <span className="na">className=</span>
                ...
                <span className="nt">&gt;</span>p-y-section-1
                <span className="nt">&lt;/h6&gt;</span>
                <span className="nt">&lt;h6</span>{" "}
                <span className="na">className=</span>
