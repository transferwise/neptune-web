      ...
      <section id="flex" className="wrap--page section">
        ...
        <div className="doc-block">
          ...
          <div className="d-flex doc-box doc-bg">
            ...
            <span className="doc-item align-self-center">.align-self-center</span>
            <span className="doc-item align-self-end">.align-self-end</span>
            <span className="doc-item align-self-baseline">.align-self-baseline</span>
            <span className="doc-item align-self-stretch">.align-self-stretch</span>
          </div>
        </div>
        <div className="doc-block">
          <h2>Wrapping</h2>
